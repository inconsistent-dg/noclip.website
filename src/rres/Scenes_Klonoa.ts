...
const sceneDescs = [
    "The Gathering Wind ~Breezegale - The Wind Village~",
    ...
    "The Songstress and the Dark King ~Guston Mine~",
    ...
    "Deep in the Withering Forest ~Forlock - The Tree Village~",
    ...
    "Over the Rising Waterfall ~The Kingdom of Jugpot~",
    ...
    "The Reawakening Forest ~Forlock - The Tree Village~",
    ...
    "A Wrench in the Works ~The Clockwork Tree House~",
    ...
    "The Desperate Journey Home ~The Ruins of the Wind Kingdom~",
    ...
    "When the Wind Dies Down ~The Leviathan's Ice Cavern~",
    ...
    "The Four Jewels ~Coronia - The Temple of the Sun~",
    ...
    "Between Light and Darkness ~The Heights of Coronia~",
    ...
    "The Kingdom of Legend ~Cress - The Moon Kingdom~",
    ...
    "The Time of Rebirth ~The Gallery of Prisms~",
    ...
    "The Dream at Nightmare's End ~The Skies Above Cress~",
    ...
    "Klonoa's Great Gale Gambit ~Balue's Tower~",
    new KlonoaSceneDesc("s810", "Extra Vision, Area 1"),
    new KlonoaSceneDesc("s811", "Extra Vision, Area 2"),
    new KlonoaSceneDesc("s812", "Extra Vision, Area 3"),
    new KlonoaSceneDesc("s813", "Extra Vision, Area 4"),
    new KlonoaSceneDesc("s814", "Extra Vision, Area 5"),
    new KlonoaSceneDesc("s815", "Extra Vision, Area 6"),
    new KlonoaSceneDesc("s816", "Extra Vision, Area 7"),
    new KlonoaSceneDesc("s817", "Extra Vision, Area 8"),
    new KlonoaSceneDesc("s818", "Extra Vision, Area 9"),
    new KlonoaSceneDesc("s820", "Extra Vision, Area 10", "tex82.bin"),
    new KlonoaSceneDesc("s821", "Extra Vision, Area 11", "tex82.bin"),
    new KlonoaSceneDesc("s822", "Extra Vision, Area 12", "tex82.bin"),
